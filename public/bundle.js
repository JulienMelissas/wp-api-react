...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      this.state.posts.map(function (post) {
	        return _react2.default.createElement(Post, { key: post.slug, title: post.title.rendered, slug: post.slug });
	      })
	    );
	  }
	});
	...
	var Post = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'li',
	      { className: this.props.slug },
	      this.props.title
	    );
	  }
	});
	
	(0, _reactDom.render)(_react2.default.createElement(Posts, null), document.getElementById('posts'));
